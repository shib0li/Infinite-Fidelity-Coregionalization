...
%%---------------Setting parameter---------------------------------------
Num_Train=100;   % 80 is best for 'ExpData3,4.mat'
Index_test=385;  % ExpData8 use 428 426 as very good 326 fail 385
...
%% ----------------Load dataset-------------------------------------------
load('ExpDataV2_2.mat') %7 is ok for HH, HH fails in 4.
